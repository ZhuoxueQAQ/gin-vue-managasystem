...
var doc = `{
    ...
    "paths": {
        ...
        "/manageSystemSetting/createManageSystemSetting": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    {
                        "description": "创建ManageSystemSetting",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/autocode.ManageSystemSetting"
                        }
                    }
                ],
                "responses": {
        ...
        "/manageSystemSetting/deleteManageSystemSetting": {
            "delete": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    {
                        "description": "删除ManageSystemSetting",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/manageSystemSetting/deleteManageSystemSettingByIds": {
            "delete": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    {
                        "description": "批量删除ManageSystemSetting",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/manageSystemSetting/findManageSystemSetting": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/manageSystemSetting/getManageSystemSettingList": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/manageSystemSetting/updateManageSystemSetting": {
            "put": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    {
                        "description": "更新ManageSystemSetting",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/autocode.Project"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "description": "这里是为了日期范围筛选添加的几个日期数组字段",
        ...
        "autocode.ManageSystemSetting": {
            ...
            "properties": {
                ...
                "incomeStreamTableCols": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/autocode.TableCol"
                    }
                },
        ...
        "autocode.Project": {
            ...
            "properties": {
                ...
                "client": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/autocode.AmountObj"
                    }
                },
                "contractEndDate": {
                    "type": "string"
                ...
                "incomeAndOutcome": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/autocode.IncomeAndOutcomeObj"
                    }
                },
                "landingAgency": {
                    "type": "array",
